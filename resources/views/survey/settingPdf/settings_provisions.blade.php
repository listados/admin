    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="{{ url('configuracao/conf-disposicoes') }}">Ressalva</a></li>
    ...
    <div class="col-md-9">
        <div class="box box-default">
            <div class="box-header with-border">
              ...
              <h3 class="box-title">Texto da Disposições Gerais atual</h3>
            </div>
            <div class="box-body">
            @foreach($setting as $settings)
                {!! $settings->settings_provisions !!}
            @endforeach
            <br>
            {{Form::open(array('url' => '/vistoria/alterar-disposicoes'))}}
            <div class="box-body pad">
                <textarea id="setting_provisions" name="settings_provisions" rows="10" cols="80"></textarea>
            </div>
            <div class="row">
                <div class="col-md-12">
