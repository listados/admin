...
var nome = "{{$name}}";
  ...
  var PSV = new PhotoSphereViewer({
    ...
    navbar: [
      ...
      {
        id: 'click-01',
        title: 'Atualiza corrigindo os erros',
    ...
    markers: (function(){
      ...
      a.push({
        ...
        latitude: 0,
        longitude: 0.20,
        image: rootURL+'/public/dist/img/upload/vistoria/loc_v360e.png',
        width: 64,
        height: 64,
...
PSV.showPanel('<h3>Em caso de erro no carregamento da imagem, click botão atualizar na barra a baixo</h3>');
