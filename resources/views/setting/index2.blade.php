            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="content-box-primary">
                        <div class="">
                            <div class="panel-title">Vistoria</div>                            
                        </div>
                    </div>
                        <div class="content-box-large box-with-header">
                            <h4> Total de Vistorias: {{ $count_survey }}</h4>
                            <h4> Cod última Vistoria: {{ $last_survey->survey_id }}</h4>
                            <h4> Tot. Vistoria Finalizada: {{ count($fininality) }}</h4>
                            <h4> Tot. Vistoria Rascunho: {{ count($draft) }}</h4>
                        </div>
                ...
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="content-box-primary">
                                <div class="panel-title">Ressalva</div>
                                
                            </div>
                            <div class="content-box-large box-with-header">
                                <label>Último usuário que alterou a ressalva foi: <strong>{{ $user_alter_reservation->name }} </strong> em : <strong> {{ date("d/m/Y H:i:s" , strtotime($alter_reservation[0]->updated_at))  }}</strong> </label>
