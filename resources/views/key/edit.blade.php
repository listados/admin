    ...
    <div class="row">
      ...
      <div class="col-md-6">
        ...
        <div class="box box-primary">
          ...
          <!-- form start -->
          <div class="box-body">
          {{Form::open(['url' => 'chaves/'.$control_key[0]->control_keys_id , 'method' => 'PUT'])}}
           ...
           <div class="row">
             ...
             <div class="col-xs-6">
              ...
              <div class="col-xs-6">
                ...
                <input type="text" name="control_keys_ref_immobile" class="form-control" value="{{ $control_key[0]->control_keys_ref_immobile   }}">
              </div>
            ...
            <div class="row">
              <div class="col-xs-4">
                ...
                <input type="number" name="control_keys_number"  value="{{ $control_key[0]->control_keys_number }}" class="form-control"  placeholder="1010">
              </div>
              <div class="col-xs-5">
                <label for="">Complemento</label>
                <input type="text" name="control_keys_complements"  value="{{ $control_key[0]->control_keys_complements }}" class="form-control"  placeholder="Ap. 801, Bloco A">
              </div>
            </div>
            <br>
            <div class="row">
      ...
      <div class="box box-info">
        ...
        @if(empty($value_delivery))
          @php $hide_value_delivery = 'hide_value_delivery'; @endphp
        @else 
          @php $hide_value_delivery = '';  @endphp
        @endif
        ...
        <div class="col-md-12" id="{{ $hide_value_delivery }}">
         ...
         <label>Valor delivery*</label><small class="text-danger"> (*Digite o valor que a imobiliária pagará)</small>            
            <input type="text" name="value_delivery"  id="delivery_value" value="{{(empty($value_delivery[0]->report_deliveries_value) ? '0,00' :  number_format($value_delivery[0]->report_deliveries_value, 2, ',' , '.'))  }}" class="form-control" placeholder="0,00">           
        </div>
             ...
             <div class="row">
               ...
               <div class="col-xs-6">
                <div class="form-group">
                  <div class="input-group">
                    ...
                    <input type="text"  name="control_keys_date_exit" value="{{ $carbon->parse($control_key[0]->control_keys_date_exit)->format('d/m/Y H:i:s') }}" class="form-control" placeholder="Retirada">
                  </div>
              ...
              <div class="col-xs-6">
                <div class="form-group">
                  <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-clock-o"></i></span>
                    <input type="text" name="control_keys_date_devolution" id="keys_date_devolution" class="form-control" placeholder="Devolução">
            ...
            <div class="row">
              ...
              <div class="col-xs-6">
                <div class="input-group">
                  ...
                  <input type="text" name="control_keys_key_number" required="true" class="form-control" value="{{ $control_key[0]->control_keys_code_key   }}">
                </div>
			...
			<div class="row">
              	<div class="col-md-12">
              		<small class="text-danger">*Se não previsar alterar a data de devolução, não precisa preencher o campo.</small>
              	</div>
              </div>
      ...
      <div class="col-md-6">
        ...
        <div class="box box-warning">
          ...
          <div class="box-body">
            <div class="row">
              <div class="col-xs-7">
                ...
                <input type="text" name="control_keys_visitor_name" class="form-control" value="{{ $control_key[0]->control_keys_visitor_name }}" placeholder="Nome completo">
              </div>
              <div class="col-xs-4">
                <label for="control_keys_visitor_cpf">CPF</label>
                <input type="text" name="control_keys_cpf" id="keys_cpf" value="{{ $control_key[0]->control_keys_visitor_cep }}" class="form-control">
              </div>
            </div>
            <br>
            <div class="input-group">
              <span class="input-group-addon"><i class="fa fa-envelope"></i></span>
              <input type="email" name="control_keys_visitor_email" value="{{ $control_key[0]->control_keys_visitor_email }}" class="form-control" placeholder="E-mail">
            </div>
            <br>
           ...
           <div class="row">
                ...
                <label for="">Fone Fixo</label>
                  <div class="input-group">
                    ...
                    <input type="text" name="control_keys_visitor_phone_one" value="{{ $control_key[0]->control_keys_visitor_phone_one }}" id="keys_visitor_phone_one" class="form-control" >
                  </div>
                </div>
              </div>
              ...
              <div class="col-xs-6">
                ...
                <label for="">Celular</label>
                   <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="keys_visitor_phone_two" value="{{ $control_key[0]->control_keys_visitor_phone_two  }}" name="control_keys_visitor_phone_two">
                  </div>
                </div>
              </div>
           </div>
            ...
            <div class="row">
              <div class="col-xs-3">
                <label for="">CEP</label>
                <input type="text" name="control_keys_visitor_cep"  id="control_keys_visitor_cep" value="{{ $control_key[0]->control_keys_visitor_cep }}" class="form-control" onblur="requestCEP($(this).attr('name') , ['control_keys_visitor_address' , 'control_keys_visitor_district' , 'control_keys_visitor_city' , 'control_keys_visitor_state'] )" >
              </div>
              <div class="col-xs-7">
                <label for="">Endereço</label>
                <input type="text" class="form-control" name="control_keys_visitor_address" id="control_keys_visitor_address"  value="{{ $control_key[0]->control_keys_visitor_address }}" placeholder="Rua/Av. Santos Dumont">
              </div>
            </div>
            <br>
            <div class="row">
              <div class="col-xs-4">
                <label for="">Número</label>
                <input type="number" class="form-control" name="control_keys_visitor_address"  id="control_keys_visitor_address" value="{{ $control_key[0]->control_keys_visitor_address }}" placeholder="1010">
              </div>
              <div class="col-xs-5">
                <label for="">Complemento</label>
                <input type="text" class="form-control" name="control_keys_visitor_complements" value="{{ $control_key[0]->control_keys_visitor_complements }}" placeholder="Ap. 801, Bloco A">
              </div>
            </div>
            <br>
            <div class="row">
              <div class="col-xs-4">
                <label for="">Bairro</label>
                <input type="text" class="form-control" name="control_keys_visitor_district" id="control_keys_visitor_district"  value="{{ $control_key[0]->control_keys_visitor_district }}">
              </div>
              <div class="col-xs-4">
                <label for="">Cidade</label>
                <input type="text" class="form-control" name="control_keys_visitor_city" id="control_keys_visitor_city" value="{{ $control_key[0]->control_keys_visitor_city }}">
              </div>
              <div class="col-xs-3">
                <label for="">Estado</label>
                <input type="text" class="form-control" name="control_keys_visitor_state" id="control_keys_visitor_state" value="{{ $control_key[0]->control_keys_visitor_state }}">
              </div>
            </div>
            <br>
            <div class="form-group">
          ...
          <div class="box-footer">
            ...
            <a href="#confSaveKey" class="btn btn-primary pull-right" data-toggle="modal"> Alterar comprovante </a>
