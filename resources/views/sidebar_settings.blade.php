...
<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="treeview"><a href="#"><i class="fa fa-home"></i> <span>Usuários</span> <i class="fa fa-angle-left pull-right"></i> </a>

          <ul class="treeview-menu">
            <li><a href="{{url('/em_desenvolvimento')}}"><i class="fa fa-home"></i> Adicionar</a></li>
            <li><a href="{{url('/em_desenvolvimento')}}"><i class="fa fa-plus"></i> Editar</a></li>
      ...
      <li class="treeview"><a href="#"><i class="fa fa-user"></i> <span>Vistoria</span> <i class="fa fa-angle-left pull-right"></i> </a>

          <ul class="treeview-menu">
            <li><a href="{{url('/em_desenvolvimento')}}"><i class="fa fa-user"></i>Aspectos Gerais</a></li>
            <li><a href="{{url('/em_desenvolvimento')}}"><i class="fa fa-user-plus"></i>Ressalva</a></li>
            <li><a href="{{url('/em_desenvolvimento')}}"><i class="fa fa-users"></i> Disposições</a></li>
      ...
      <li class="treeview"><a href="#"><i class="fa fa-bar-chart"></i> <span>Financeiro</span> <i class="fa fa-angle-left pull-right"></i> </a>
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="{{url('/em_desenvolvimento')}}"><i class="fa fa-pie-chart"></i>Relatórios</a></li>
          </ul>
      </li>
      ...
      <li class="treeview"><a href="#"><i class="fa fa-gift"></i> <span>Apps</span> <i class="fa fa-angle-left pull-right"></i> </a>
          ...
          <ul class="treeview-menu">
            <li><a href="{{url('/em_desenvolvimento')}}"><i class="fa fa-money"></i>Avaliação</a></li>
