...
<div class="modal fade" id="{{ $id_alter_fun }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">
                    ...
                    Atendente da proposta nº {{ $id_proposal }}
                </h4>
            </div>
            <div class="modal-body">
                <div class="form-group">
                    <label for=""> {{ $text_modal .' '.(empty($name_users->name) ? 'Não informado' : $name_users->name) }}</label>
                </div>
                ...
                <div class="container-fluid bd-example-row">
                    <div class="row">
                        <div class="col-md-6">
                          ...
                          {{ Form::hidden($name_camp, $id_proposal)}}
