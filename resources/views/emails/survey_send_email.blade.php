...
<div  style="border: 1px solid #c3c3c3;padding-right: 15px; padding-left: 15px;margin-right: auto;margin-left: auto;background: #fff; border-radius: 5px; width: 600px;">
	<table style="align: center;">
		...
		<tr style="text-align: center;">
			<td><p>Olá!</p>
				<p>Você está recebendo a vistoria do imóvel <b>{{$survey->survey_address_immobile}}</b>, realizado por <label for="espindola" style="color: #333333;"> <strong>Espindola Imobiliária</strong> </label> </p>
			</td>			
		</tr>
		<tr  style="text-align: center;">
			<td> <p> Para visualizar e aceitar a vistoria clique no link abaixo.</p>  </td>
		</tr>
		
		<tr style="text-align: center;">
			<td><a href="{{ url('/visualizar-vistoria-pdf/'.base64_encode($survey->survey_id)) }}" style="width: 170px;min-height: 50px; background: #5cb85c;color: white;
