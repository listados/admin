...
use AdminEspindola\Business;
use DB, PDF, Validator;
use Image, Mail, Auth, Session;
...
class BusinessController extends Controller
{
    ...
    public function index()
    {
        ...
        Session(['business_name' => $business->business_name_corporation]);
        Session(['business_fantasia' => $business->business_fantasy]);
